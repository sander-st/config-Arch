...
return {
	...
	default = {
		...
		web_browser = "firefox",
                --- chrome browser
                chrome_browser= "google-chrome-stable",
	...
	utils = {
		...
		full_screenshot = utils_dir .. "scrot /home/s4nder/Screenshots/%Y-%m-%d-%T.png",
		--- Area screenshot
		area_screenshot = utils_dir .. "scrot -s /home/s4nder/Screenshots/%Y-%m-%d-%T.png",
		--- Color Picker
