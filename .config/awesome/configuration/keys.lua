...
awful.keyboard.append_global_keybindings({
	...
	end, { description = "keyboard languaje set us_US", group = "hotkeys" }),
  --- set languaje espanish
	awful.key({ mod, shift }, "e", function()
		awful.spawn("setxkbmap es")
	end, { description = "keyboard languaje set es_ES", group = "hotkeys" }),
	-- Terminal
	...
	awful.key({ mod, shift }, "g", function()
		awful.spawn(apps.default.chrome_browser)
	end, { description = "open chrome browser", group = "app" }),
